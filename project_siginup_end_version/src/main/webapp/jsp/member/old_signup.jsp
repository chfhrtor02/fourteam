...
<table class="table table-bordered w-50 mx-auto">
	...
	<tr>
		<th>패스워드 </th>
		<td> 
			<input type="password" id="member_pwd" name="member_pwd" class="form-control w-50">	
	...
	<tr>
		<th>생일(6자리로)</th>
		<td> 
			<input type="text" id="member_birthday" name="member_birthday" class="form-control w-75">	
		</td>
	</tr>
	<tr>
		<td colspan="2">
