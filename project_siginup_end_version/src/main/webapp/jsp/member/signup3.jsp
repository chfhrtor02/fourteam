...
$(function(){
	...
	$("#submit_btn").click(function(){
		...
		console.log("기본주소:"+$("#member_addr1").val()+"@@");
		console.log("상세주소:"+$("#member_addr2").val()+"@#");
			
		if($("#member_addrn").val().trim()!=="" &&
		   $("#member_addr2").val().trim()!==""	&&
		   $("#member_addr2").val().trim()!=="")
		{
			$("#msg_addr_error").html("");			
		...
		/* 	$("#memberVO").submit(); */
		    ...
		    if(formFlag.addr1check == false){
		    	$("#member_addrn").val("");		
		    	$("#member_addr1").val("");
		    	$("#member_addr2").val("");	
		    	$("#addrsearch_btn").focus();//우편번호버튼에 포커스
		    	$("#msg_addr_error").html("주소입력하세요");
		    } 
		...
		<tr>
			...
			<td> 
				...
				<span id="msg_name_error" class="err">
					<form:errors path="member_name" cssClass="err"/>
				</span>
			</td>
		</tr>
		<!-- 성별 -->
		...
		<tr>
			...
			<td> 
				...
				<span id="msg_birthday_error" class="err">	
					<form:errors path="member_birthday" cssClass="err" />
				</span>
			</td>
		</tr>
		<tr>
